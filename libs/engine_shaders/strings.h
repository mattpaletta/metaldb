...
namespace metal {
    namespace strings {
        ...
        template <typename T = METAL_DEVICE char*, typename V = METAL_DEVICE char*> static int strcmp(const T str1, const T str2) {
        ...
        template <typename T = METAL_DEVICE char*, typename V = METAL_DEVICE char*> static T strncpy(T destination, const V source, size_t num) {
            V sourcePtr = source;
        ...
        template <typename T = METAL_DEVICE char*, typename V = METAL_DEVICE char*> static T strcpy(T destination, const T source) {
        ...
        template <typename T = METAL_DEVICE char*, typename V = METAL_DEVICE char*> static T strncat(T destination, const V source, size_t num) {
        ...
        template <typename T = METAL_DEVICE char*, typename V = METAL_DEVICE char*> static T strcat(T destination, const V source) {
            T endOfDest = destination;
        ...
        template <typename T = METAL_DEVICE char*> static size_t strlen(const T str) {
            size_t size = 0;
        ...
        template <typename T = METAL_DEVICE char*> static T const strchr(T const str, int character) {
        ...
        template <typename T = METAL_DEVICE char*> static T const strnchr(T const str, size_t length, int character) {
            const char charToFind = character;
            T strPtr = str;
        ...
        template <typename T = METAL_DEVICE char*> static int64_t const stoi(T const str, size_t length) {
            int64_t result = 0;
            for (size_t i = 0; i < length; ++i) {
                if (i > 0) {
                    result *= 10;
        ...
        template <typename T = METAL_DEVICE char*> static float const stof(T const str, size_t length) {
            // Find first part
