...
namespace metaldb {
    namespace details {
         ...
         */
        template <typename T> static constexpr size_t DetermineAlignment(size_t baseOffset) {
    ...
    public:
         ...
         */
        static SizeOfHeaderType SizeOfHeader(NumColumnsType numColumns) CPP_NOEXCEPT {
