...
namespace metaldb {
    ...
    public:
        ...
        MethodType GetMethod() const CPP_NOEXCEPT {
            return ReadBytesStartingAt<MethodType>(&this->_instructions[MethodOffset]);
        }
        
        SkipHeaderType SkipHeader() const CPP_NOEXCEPT {
        ...
        ColumnType GetColumnType(NumColumnsType index) const CPP_NOEXCEPT {
         ...
         */
        StringSection ReadCSVColumn(RawTable METAL_THREAD & rawTable, RowNumType row, NumColumnsType column) const CPP_NOEXCEPT {
         ...
         * @note This class utilizes internal caching for significantly better performance on incrementing column numbers.
         */
        ColumnSizeType ReadCSVColumnLength(RawTable METAL_THREAD & rawTable, RowNumType row, NumColumnsType column) const CPP_NOEXCEPT {
         ...
         */
        TempRow GetRow(DbConstants METAL_THREAD & constants) CPP_NOEXCEPT {
    ...
    private:
         ...
         */
        void AdvanceColumn(METAL_DEVICE char** startOfColumn, RawTable METAL_THREAD & rawTable, RowNumType row, NumColumnsType column) const CPP_NOEXCEPT {
         ...
         */
        METAL_DEVICE char* GetStartOfColumn(RawTable METAL_THREAD & rawTable, RowNumType row, NumColumnsType column) const CPP_NOEXCEPT {
         ...
         */
        StringSection ReadCSVColumnImpl(RawTable METAL_THREAD & rawTable, RowNumType row, NumColumnsType column) const CPP_NOEXCEPT {
