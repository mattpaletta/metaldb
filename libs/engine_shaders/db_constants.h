...
namespace metaldb {
    ...
    public:
        ...
        DbConstants(RawTable METAL_THREAD& rawTable_, OutputSerializedValue METAL_DEVICE* outputBuffer_, OutputRow::NumBytesType METAL_THREADGROUP* rowSizeScratch_)
            : rawTable(rawTable_), outputBuffer(outputBuffer_), rowSizeScratch(rowSizeScratch_) {}
