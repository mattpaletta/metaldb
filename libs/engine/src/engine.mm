...
auto metaldb::engine::Engine::runImpl() -> Dataframe {
  ...
  auto parseAst = parser.Parse("eg query.");
  {
    ...
    taxiTable.filePath = "../../datasets/taxi";
    {
      ...
      taxiTable.columns.emplace_back("lpep_pickup_datetime", 20,
                                     ColumnType::String);
      taxiTable.columns.emplace_back("lpep_dropoff_datetime", 20,
                                     ColumnType::String);
      taxiTable.columns.emplace_back("store_and_fwd_flag", 1,
                                     ColumnType::String);
      ...
      taxiTable.columns.emplace_back("improvement_surcharge",
                                     ColumnType::Float);
